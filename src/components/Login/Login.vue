        ...
        <div id="s_main" class="clearfix">
          <el-row>
            <el-col :span="24" style="border-bottom: 1px solid #e9e9e9;">
              <div id="newsTitle">
                <p class="el-icon-star-off">{{title}}</p>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="16" style="border-right: 1px solid #e9e9e9;">
              ...
              <div id="newsContent">
                <div v-for="item in searchNews" class="newsItem">
                  <a class="itemTitle" :href="item.url" target="_blank" v-html="item.title" />
                  <p
                    class="itemSource"
                  >{{item.source==NULL?"中国新闻网":item.source}}&ensp;&ensp; {{item.time}}</p>
                  <p v-html="item.snippet" class="itemContent" />
                  <div class="itemOther">
                    <el-popover placement="right" width="680" trigger="click">
                      <div
                        v-for="relat in relateNews"
                        class="newsItem"
                        style="margin:10px;padding-bottom:10px;"
                      >
                        <a class="itemTitle" :href="relat.url" target="_blank" v-html="relat.title"></a>
                        <p class="itemSource">{{relat.source}}&ensp;&ensp; {{relat.time}}</p>
                        <p v-html="relat.snippet" class="itemContent"></p>
                      </div>
                      <el-button
                        slot="reference"
                        type="text"
                        size="mini"
                        style="color: #7a77c8;font-size:13px;margin-right:10px;"
                        @click="showRealteNews(item.id)"
                      >查看更多相关新闻>></el-button>
                    </el-popover>
                    ...
                    <el-popover placement="right" width="800" trigger="click">
                      <div class="details">
                        ...
                        <p class="time">{{item.source}}&ensp;&ensp; {{item.time}}</p>
                      ...
                      <el-button
                        ...
                        type="text"
                        size="mini"
                        style="color: #666;font-size:13px;margin-right:10px;"
                      >新闻快照</el-button>
                    </el-popover>
                    ...
                    <el-popover placement="right" width="500" trigger="click">
                      <div v-for="(com,index) in comments" class="commentStyle">
                        <el-row>
                          ...
                          <el-col :span="12">
                            <p class="commentTime">{{com.cmt_time}}</p>
                          </el-col>
                        </el-row>
                        <el-row style="margin: 15px 0 10px 0;">
                          <el-col :span="22" :offset="1">
                            <p class="commentContent">{{com.hot_content}}</p>
                          </el-col>
                        </el-row>
                        <el-row>
                          <el-col :span="24">
                            <span style="float:right;">
                              <el-rate
                                v-model="apprise[index]"
                                :colors="['#99A9BF', '#F7BA2A', '#FF9900']"
                                :texts="['贬义评论', '近似贬义', '中性评论', '近似褒义', '褒义评论']"
                                show-text
                              ></el-rate>
                            </span>
                          </el-col>
...
#s_main {
  ...
  border-color: rgba(226, 226, 226, 0.9) !important;
  border-radius: 5px;
  padding: 0px;
  margin-bottom: 50px;
}
